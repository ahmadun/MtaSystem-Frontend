...
const ChecksheetHolidaysPage = Loadable(lazy(() => import("app/views/master/ChecksheetHolidaysPage")));
...
const routes = [
  { path: "/", element: <Navigate to="dashboard" /> },
  {
    ...
    children: [
      ...
      { path: "/master/calendar", element: withRoles(<ChecksheetHolidaysPage />, adminRoles) },
